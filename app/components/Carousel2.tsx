    ...
    return (
        <div className='CaseStudy_card flex flex-col lg:flex-row'>
            <Slider {...settings} className="overflow-hidden">
                ...
                <div className='CaseStudy_card w-full flex lg:flex-row'>
                    <div className='h-[261px] w-full bg-slate-200'>
                        <Image src={Image1} alt={'case-study-image'} className="h-full w-[300px]" />
                    </div>
                    <div>
                        ...
                        <div style={{
                            ...
                            letterSpacing: '-3%',
                            lineHeight: '58px'
                        }} className='CaseStudy_card_text-title mt-[32px] text-center'>
                ...
                <div className='CaseStudy_card_text w-full'>
